...
@section('title', __('service.title_index'))
@section('content')
    <!-- Page content -->
    <div class="page-content pt-0">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.service.create"/>
                    </div>
                        ...
                        <table class="table table-hover table-bordered table-striped">
                            ...
                            @foreach($services as $service)
                                <tr>
                                    <td>{{$service->id}}</td>
                                    <td>{{$service->name}}</td>
                                    <td><img src="{{$service->image()}}"  width="130" height="130" alt=""/></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <x-edit route="admin.service.edit" :id="$service->id"/>
                                            <x-delete route="admin.service.destroy" :id="$service->id"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
