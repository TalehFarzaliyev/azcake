...
@section('title', __('role.title_create'))
@section('content')
    <!-- Page content -->
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    @foreach($permissions as $permission)
                                        ...
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input name="permission[]" type="checkbox" class="custom-control-input" id="custom_checkbox_inline_unchecked_{{$permission->id}}"  value="{{ $permission->id }}">
