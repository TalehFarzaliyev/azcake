...
@section('title', __('customer.title_create'))
@section('content')
    <!-- Page content -->
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="text" name="first_name" id="first_name" class="form-control @error('first_name') border-danger @enderror" placeholder="{{__('messages.firstname')}}" value="{{ old('first_name') }}">
                                    </div>
                                    @error('first_name')
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="text" name="last_name" id="last_name" class="form-control @error('last_name') border-danger @enderror" placeholder="{{__('messages.lastname')}}" value="{{ old('last_name') }}">
                                    </div>
                                    @error('last_name')
                                    <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                                    @enderror
