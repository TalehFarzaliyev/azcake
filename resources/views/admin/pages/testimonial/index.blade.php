...
@section('title', __('testimonial.title_index'))
@section('content')
    <!-- Page content -->
    <div class="page-content pt-0">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.testimonial.create"/>
                    </div>
                        ...
                        <table class="table table-hover table-bordered table-striped">
                            ...
                            @foreach($testimonials as $testimonial)
                                <tr>
                                    ...
                                    <td><img src="{{$testimonial->image()}}"  width="130" height="130" alt=""/></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <x-edit route="admin.testimonial.edit" :id="$testimonial->id"/>
                                            <x-delete route="admin.testimonial.destroy" :id="$testimonial->id"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
