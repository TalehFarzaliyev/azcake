...
@section('title', __('category.title_index'))
@section('content')
    <!-- Page content -->
    <div class="page-content pt-0">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.category.create"/>
                    </div>
                        ...
                        <table class="table table-hover table-bordered table-striped">
                            ...
                            @foreach($categoryies as $category)
                                <tr>
                                    <td>{{$category->id}}</td>
                                    <td>{{$category->name}}</td>
                                    <td>{{$category->parent ? $category->parent->name : __('messages.main').' '.__('category.category')}}</td>
